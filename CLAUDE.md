...
[VellumPDF#91](https://github.com/Tim81/VellumPDF/issues/91); CI veraPDF-gates a
PDF/A-2b sample for each). 1.5.3 had restored signed PDF/A-2b conformance
([VellumPDF#89](https://github.com/Tim81/VellumPDF/issues/89)); 1.1.0 added PAdES
signing (#24) and custom PDF/A output intents (`Set-VellumPdfOutputIntent`).
